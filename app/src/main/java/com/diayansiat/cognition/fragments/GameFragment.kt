package com.diayansiat.cognition.fragments
...
import com.diayansiat.cognition.*
...
class GameFragment : Fragment() {
    ...
    private fun showDownloadDialog() {
        val boardDownloadView =
            LayoutInflater.from(context).inflate(R.layout.dialog_download_board, null)
    ...
    private fun showCreationDialog() {
        ...
        val boardSizeView = LayoutInflater.from(requireContext()).inflate(R.layout.dialog_board_size, null)
    ...
    private fun showNewSizeDialog() {
        //create a radio group for the user to choose the game they want to play
        val boardSizeView = LayoutInflater.from(context).inflate(R.layout.dialog_board_size, null)
        val radioGroupSize = boardSizeView.findViewById<RadioGroup>(R.id.radioGroup)
        when (boardSize) {
    ...
    private fun setupGameBoard() {
        //TODO: change title of app to the game name
